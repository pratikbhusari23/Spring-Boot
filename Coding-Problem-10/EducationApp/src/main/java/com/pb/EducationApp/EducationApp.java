...
public class EducationApp {
	...
	public static void main(String[] args) {
		System.out.println("Welcome to the Education application"); 
		...
		paidCourse.setCourseDetails("Basics of Java");
		System.out.println(paidCourse.getCourseName());
		paidCourse.setCourseInstructor("javaInstructor");
		paidCourse.getInstructor().setInstructorDetails("Rahul Mohan", "27");
